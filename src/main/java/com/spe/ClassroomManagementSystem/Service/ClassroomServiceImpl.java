...
public class ClassroomServiceImpl implements ClassroomService {
    ...
    @Override
    public List<Classroom> getreAvailableClassrooms(long capacity, long plugs, boolean projectorNeeded, Time startTimeFormat, Time endTimeFormat, Day day, Date date) {
...
//        for every classroom
	...
	@Override
	public Internship saveInternship(Internship intern) {
