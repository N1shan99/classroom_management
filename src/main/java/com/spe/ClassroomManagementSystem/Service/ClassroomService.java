...
public interface ClassroomService {
    ...
    List<Classroom> getreAvailableClassrooms(long capacity, long plugs, boolean projectorNeeded,  Time startTimeFormat, java.sql.Time endTimeFormat, Day day,Date date);

    Internship saveInternship(Internship intern);
