...
<body>
<%
session.setAttribute("selectedDates",null);
...
<nav class="navbar navbar-fixed-top navbar-light" style="background-color: #563D7C; ">
    <!-- Navbar content -->
    <a class="navbar-brand" href="#">Clasroom Manager</a>
        ...
        <div class="form-box">
            <form  id="dashboard-form" action="/getAvailableClasses" method="">
                ...
                <select id="purpose" name="purpose" required>
                    ...
                    <option name="interactionWithSac" value="interactionWithSac">Interaction with Faculties</option>
                    <option name="interactionWithCommittee" value="interactionWithCommittee">Interaction with Students </option>
                </select>
                </div>
<%--                <div class="form-group">--%>
...
<%--                </div>--%>
                ...
                <h5 id="date-label" align="left">Start Date</h5>


                <div class="form-group">
                        <input id="startDate" name="startDate" type="date" class="DateFrom" required placeholder="Date">
                </div>



               <h5 id="date-label" align="left">End Date</h5>


                <div class="form-group">
                        <input id="endDate" name="endDate" type="date" class="DateFrom" required placeholder="Date">
                </div>
